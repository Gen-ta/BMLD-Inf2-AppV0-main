...
st.title("💡 Tipps & Tricks für einen gesunden Körper")

st.markdown("""
### Ernährung
- **Ausgewogene Ernährung:** Achte auf eine ausgewogene Ernährung mit viel Obst, Gemüse, Vollkornprodukten und magerem Protein.
- **Wasser trinken:** Trinke täglich ausreichend Wasser, mindestens 1.5 bis 2 Liter.
